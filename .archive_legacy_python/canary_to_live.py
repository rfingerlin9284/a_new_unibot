...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/home/ing/RICK/R_H_UNI/logs/canary_promotion.log'),
...
# Paths
ROOT = Path("/home/ing/RICK/R_H_UNI")
...
class CanaryPromotion:
    ...
    def _parse_session_output(self, output: str) -> Dict:
        """Parse ghost trading engine output"""
        data = {
            "status": "completed",
            "timestamp": datetime.now().isoformat()
        }
        
        # Look for final report file
    ...
    def promote_to_live(self, reason: str) -> bool:
        ...
        # Flip the toggle
        TOGGLE_FILE.write_text("ON")
        logger.info("✅ .upgrade_toggle = ON")
